								...
								<div class="row">
                                    ...
                                    <?php if($row->image_name == ""){?>
										<div class="center">
                                            ...
                                            <div class="center">
											<span class="profile-picture">
												<img height="200" width="200" id="avatar" src="<?php echo base_url(); ?>img/staff/<?php echo $row->staff_id; ?>/<?php echo $row->image_name; ?>"></img>
											</span>
                                            <?php } ?>
										...
										<div class="row">
											...
											<div class="col-xs-2"></div>
												<div class="center col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-8 ">
													<a href="<?php echo base_url(); ?>index.php/staff/edit_profile" class="btn btn-sm btn-block btn-default">
										...
										<form class="form-horizontal" role="form">
											...
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-10">
													<input name="id" type="text" class="form-control" readonly="readonly" value="<?php echo $row->staff_ic; ?>" >
												</div>
											</div>
                                            </div>
                                            <div class="col-md-6 col-xs-12" >
