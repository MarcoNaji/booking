				...
				function tooltip_placement(context, source) {
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo base_url(); ?>index.php/staff/manage_shift">Manage Shift</a>
							</li>
					...
					<div class="page-content">
						<div class="row">
							<div class="col-xs-12">
                                ...
                                <!-- PAGE CONTENT BEGINS -->
								<a href="<?php echo base_url(); ?>index.php/staff/manage_shift"><button type="button" class="btn btn-xs btn-danger">
                     ...
                     <form class="form-horizontal" id="submit_form" method="post" action="<?php echo base_url(); ?>index.php/staff/edit_shift/<?php echo $row->shift_id; ?>">
											<table class="table table-striped table-bordered no-margin-bottom">
												...
												<tbody>
                                                    ...
                                                    <td class="center">Start Time:</td>
														<td><span class="input-group bootstrap-timepicker"><input name="start_time" type="text" class="form-control" id="timepicker1" value="<?php echo $row->from;?>"></span></td>
                                                        <td class="center">End Time:</td>
														<td><span class="input-group bootstrap-timepicker"><input name="end_time" type="text" class="form-control" id="timepicker2" value="<?php echo $row->to;?>"></span></td>
                                                        </tr>
												</tbody>
												</table>
												...
												<div class="clearfix form-actions">
		       													<div class="center">
		       													<button type="reset" class="btn btn-lg btn-gray">
		                													Reset
		            												</button>
