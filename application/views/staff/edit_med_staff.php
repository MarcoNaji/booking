            ...
            form.submit();
				...
				function tooltip_placement(context, source) {
					...
					<div class="page-content">
						<div class="row">
							<div class="col-xs-12">
                            <form id="edit_form" class="form-horizontal" method="post" action="<?php echo base_url(); ?>index.php/staff/save_edit_med_staff/<?php echo $row->staff_id; ?>" novalidate="novalidate">
