						...
						<div class="page-header">
							<h1>
								...
								<div class="btn-toolbar pull-right">
											<div class="btn-group">
												...
												<ul class="dropdown-menu dropdown-info pull-right">
													<li>
														<a href="<?php echo base_url(); ?>index.php/staff/view_pat/<?php echo $id; ?>">Patient Details</a>
													</li>

													<li>
														<a href="<?php echo base_url(); ?>index.php/staff/d_record/<?php echo $id; ?>"><b>Dialysis Record</b></a>
													</li>

													<li>
														<a href="<?php echo base_url(); ?>index.php/staff/view_summary/<?php echo $id; ?>">Clincal and Biochemistry Summary</a>
													</li>
													
													<li>
														<a href="<?php echo base_url(); ?>index.php/staff/view_history/<?php echo $id; ?>">Patient History</a>
													</li>
                                ...
                                <div class="form-group col-sm-5">
									...
									<a href="#modal-form" role="button" class="blue" data-toggle="modal">Insert New Record</a>
								</h4>
											...
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th class="hidden-480">Machine</th>
                                                ...
                                                <?php foreach($record as $row): ?>
													<tr>
														...
														<td class="hidden-480"><?php  if($row->machine_id == ""){echo "Not Specified";}else{foreach($machine as $mrow): if($row->machine_id == $mrow->machine_id){echo $mrow->name;} endforeach; } ?>
														</td>

														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<a title="View" class="blue" href="<?php echo base_url(); ?>index.php/staff/view_record/<?php echo $row->record_id; ?>/<?php echo $id; ?>">
...
<a title="Print" class="orange" href="<?php echo base_url(); ?>index.php/print_report/single_drecord_report/<?php echo $row->pat_id; ?>/<?php echo $row->record_id; ?>" target="_blank">
																...
																<?php /*<a title="Delete" onclick="if (confirm('Are You Sure To  Delete Treatment # <?php echo $row->treatment_no; ?>?')){ return true;} else{return false;}" class="red" href="<?php echo base_url(); ?>index.php/staff/delete_record/<?php echo $row->id; ?>/<?php echo $ic; ?>">
															...
															<div class="visible-xs visible-sm hidden-md hidden-lg">
																<div class="inline position-relative">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
																		<li>
																			<a href="<?php echo base_url(); ?>index.php/staff/view_record/<?php echo $row->record_id; ?>/<?php echo $id; ?>" class="tooltip-info" data-rel="tooltip" title="View">
																				<span class="blue">
...
<div id="modal-form" class="modal" tabindex="-1">
									<div class="modal-dialog">
                                     <form method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>index.php/staff/add_record_page/<?php echo $id; ?>">
											...
											<div class="modal-body overflow-visible">
												<div class="row">
													<div class="col-xs-12 col-sm-5">
														...
														<span>Patient's Condition Observation:
													</div>
	...
	<label class="form-field-date" style="text-align: left;">&nbsp;</label>																<div class="input-group">
																<select name="observeation_no" class="form-control"  type="text" >
             <?php for($i=1; $i<=30; $i++){?>                                                       <option><?php echo $i; ?></option>
             <?php } ?></select>
