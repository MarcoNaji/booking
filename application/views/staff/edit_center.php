				...
				function tooltip_placement(context, source) {
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
                            ...
                            <li>
								<i class=""></i>
								<a href="<?php echo base_url(); ?>index.php/staff/center">Center Info</a>
							</li>
					...
					<div class="page-content">
						<div class="row">
							<div class="col-xs-12">
                            <form id="edit_form" class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>index.php/staff/save_edit_center" novalidate="novalidate">
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				.find('input[type=file]').ace_file_input({
					style:'well',
					btn_choose:'Click and Choose Image',
					btn_change:null,
				...
				.find('input[type=file]').ace_file_input({
					style:'well',
					btn_choose:'Click and Choose Logo',
					btn_change:null,
					no_icon:'icon-picture',
					thumbnail:'large',
					droppable:true,
