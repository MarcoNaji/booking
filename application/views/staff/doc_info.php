				...
				$('#timepicker').timepicker({
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
                            ...
                            <li>
							<a href="<?php echo base_url(); ?>index.php/staff/view_doc">Doctors</a>
                            </li>
								...
								<div class="row">
									<div class="col-md-4" >
										...
										<div class="center">
                                            ...
                                            <div class="center">
											<span class="profile-picture">
												<img height="200" width="200" id="avatar" class="editable img-responsive" alt="Alex's Avatar" src="<?php echo base_url(); ?>img/doc/<?php echo $row->doc_id; ?>/<?php echo $row->image_name; ?>"></img>
											</span>
                                            <?php } ?>
										...
										<div class="row">
											...
											<div class="col-xs-2"></div>
                                                ...
                                                <?php 
												foreach($doc as $row):{ $num_supervision = $row->supervision;}endforeach;
												if($supervision_num_row == 0){ 
												if($num_supervision != 0){  ?>
													<a href="<?php echo base_url(); ?>index.php/staff/req_sup_doc/<?php echo $ic; ?>" class="btn btn-sm btn-block btn-primary">
													...
													</button> <?php }elseif($sup_status=="rejected"){ if($num_supervision !=0){?> <a href="<?php echo base_url(); ?>index.php/staff/update_req_sup_doc/<?php echo $ic; ?>/<?php echo $request_id; ?>" class="btn btn-sm btn-block btn-primary">
														<i class="icon-share-alt bigger-120"></i>
														<span class="bigger-110">Request Supervision</span>
													</a> <?php }else{?> <button disabled="disabled" class="btn btn-sm btn-block btn-danger">
														<span class="bigger-110">Full</span>
													</button> <?php } }elseif($sup_status=="pending"){?> <a onclick="if (confirm('Are You Sure To  Cancel Supervision Request?')){ return true;} else{return false;}" href="<?php echo base_url(); ?>index.php/staff/cancel_req_sup_doc/<?php echo $ic; ?>/<?php echo $request_id; ?>" title="Click to Cancel" class="btn btn-sm btn-block btn-warning">
														<span class="bigger-110">Supervision Request Pending</span>
													</a><?php }elseif($sup_status=="deleted"){ if($num_supervision!=0){?> <a href="<?php echo base_url(); ?>index.php/staff/update_req_sup_doc/<?php echo $ic; ?>/<?php echo $request_id; ?>" class="btn btn-sm btn-block btn-primary">
														<i class="icon-share-alt bigger-120"></i>
														<span class="bigger-110">Request Supervision</span>
													</a> <?php }else{?> <button disabled="disabled" class="btn btn-sm btn-block btn-danger">
														<span class="bigger-110">Full</span>
...
<td class="center"><a href="<?php echo base_url(); ?>index.php/staff/cancel_req_doc/<?php echo $ic; ?>/<?php echo $row->id; ?>"><button type="button" class="btn btn-xs btn-danger">Cancel</button></a></td>												</tr>
                                                            <?php } endforeach; ?>
...
<?php echo $row->status; ?></span></td>											</tr>
       ...
       <div id="modal-form" class="modal" tabindex="-1">
									<div class="modal-dialog">
                                     <form method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>index.php/staff/request_doc/<?php echo $ic; ?>">
