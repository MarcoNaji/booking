				...
				function tooltip_placement(context, source) {
					...
					<div class="page-content">
						<div class="page-header">
                            ...
                            <button class="btn btn-danger btn-sm" type="button"  onclick="location.href='<?php echo base_url(); ?>index.php/staff/view_history/<?php echo $pat_id; ?>'">
	...
	<?php if($row->gender != "Male"){?>														<option>Male</option>
		...
		<?php } ?>												</select>
                                    ...
                                    <div class="row">
										...
										<div class="col-md-6  col-xs-12">
											<div class="form-group">
												<label class="col-sm-2 control-label alignleft">Relation:</label>
												<div class="col-md-7 col-md-offset-1 col-sm-9" >
                                ...
                                <div class="row">
										<?php 
												...
												$doctor = $row->doc_id;
												 ?>
										<div class="form-group">
												<label class="col-sm-2 control-label alignleft">Nephrologist:</label>
											<div class="input-group col-md-6 col-sm-9 col-xs-12" >
												<select name="neph_incharge" readonly="readonly" class="form-control" id="form-field-select-1">
                                                
												<option value="<?php echo $nephro; ?>"><?php foreach($neph_d as $nrow): if($nrow->neph_id == $nephro){echo $nrow->name;} endforeach;?></option>
											</select>
											</div>
										</div>

										<div class="form-group">
											<label class="col-sm-2 control-label alignleft">Doctor:</label>
											<div class="input-group col-md-6 col-sm-9 col-xs-12" >
												<select name="doc_incharge" readonly="readonly" class="form-control" id="form-field-select-1">
												<option value="<?php echo $doctor; ?>"><?php foreach($doc_d as $drow): if($drow->doc_id == $doctor){echo $drow->name;} endforeach;?></option>
											</select>
											</div>
										</div>
