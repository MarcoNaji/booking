				...
				function tooltip_placement(context, source) {
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
                            ...
                            <li>
							<a href="<?php echo base_url(); ?>index.php/staff/med_staff">Medical Staff</a>
                            </li>
										...
										<div class="row">
											...
											<div class="col-xs-2"></div>
												<div class="center col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-8 ">
													...
													<a href="<?php echo base_url(); ?>index.php/staff/edit_med_staff/<?php echo $row->staff_id; ?>" class="btn btn-sm btn-block btn-default">
														<i class="icon-edit bigger-120"></i>
														<span class="bigger-110">Edit</span>
													</a>
                                                    <a onclick="if (confirm('Are You Sure To  Delete <?php echo $row->name; ?>?')){ return true;} else{return false;}" href="<?php echo base_url(); ?>index.php/staff/delete_med_staff/<?php echo $row->staff_id; ?>" class="btn btn-sm btn-block btn-danger">
