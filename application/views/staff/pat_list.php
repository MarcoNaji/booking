								...
								<div class="row">
									...
									<a href="<?php echo base_url(); ?>index.php/staff/patient" role="button" class="blue" data-toggle="modal">Add New Patient</a>
										...
										<div class="table-header">
											Sorted by : <a href="<?php echo base_url(); ?>index.php/staff/sort_patient/today"><font color="black">Today</font></a> / <a href="<?php echo base_url(); ?>index.php/staff/sort_patient/all"><font color="black"><u>All</font></u></a> Patients
