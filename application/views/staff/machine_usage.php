				...
				function tooltip_placement(context, source) {
					...
					<div class="page-content">
						<div class="page-header">
							<h1>
								<?php foreach($machine as $row): echo $row->name; endforeach;?> Usage History</h1>
						</div>
								<!-- PAGE CONTENT BEGINS -->
									...
									<div class="col-xs-12">
										...
										<div class="table-responsive">
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<tbody>
                                                <?php foreach($machine_usage as $row): ?>
													<tr>
														<td class="center">
															<label>
																<input type="checkbox" disabled="disabled" class="ace" />
														...
														<td>
															<?php foreach($patient as $prow): if($row->pat_id == $prow->pat_id){echo $prow->name; } endforeach; ?>
														</td>
                                                       
														<td><?php foreach($patient as $prow): if($row->pat_id == $prow->pat_id){echo $prow->pat_ic; } endforeach; ?></td>
                                                         <td>
															<?php echo $row->date; ?>
														</td>
														<td>
															<?php echo $row->arrival_time." - ".$row->leaving_time; ?>
														</td>
													</tr>
                                                    <?php endforeach; ?>
												</tbody>
