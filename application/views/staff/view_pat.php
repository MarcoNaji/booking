							...
							<div class="btn-toolbar pull-right">
											<div class="btn-group">
												...
												<ul class="dropdown-menu dropdown-info pull-right">
													<li>
														<a href="<?php echo base_url(); ?>index.php/staff/view_pat/<?php echo $row->pat_id; ?>"><b>Patient Details</b></a>
													</li>

													<li>
														<a href="<?php echo base_url(); ?>index.php/staff/d_record/<?php echo $row->pat_id; ?>">Dialysis Record</a>
													</li>

													<li>
														<a href="<?php echo base_url(); ?>index.php/staff/view_summary/<?php echo $row->pat_id; ?>">Clincal and Biochemistry Summary</a>
													</li>
													
													<li>
														<a href="<?php echo base_url(); ?>index.php/staff/view_history/<?php echo $row->pat_id; ?>">Patient History</a>
													</li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div id="user-profile-2" class="user-profile">
                                 <form class="form-horizontal" id="edit-form" enctype="multipart/form-data" method="post" action="<?php echo base_url(); ?>index.php/staff/edit_pat/<?php echo $id; ?>" novalidate="novalidate">
                                  <?php foreach($patient as $row):
										$status = $row->status;
...
echo $drow->title; echo $drow->name;														
									...
									<ul class="ace-thumbnails">
										...
										<li>
											...
											<div class="tools tools-bottom">
												...
												<a title="Delete" onclick="if (confirm('Are You Sure To  Delete This Image?')){ return true;} else{return false;}" href="<?php echo base_url(); ?>index.php/staff/delete_profile_pic/<?php echo $row->pat_id; ?>">
							...
							<div class="col-md-8">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="ic" id="ic" value="<?php echo $ic = $row->pat_ic ; ?>" class="form-control" >
										</div>
									</div>
										...
										<div class="col-md-6  col-xs-12">
											<div class="form-group">
												...
												<div class="input-group col-md-6 col-sm-9 col-xs-12" >
													<select class="form-control" name="gender" id="form-field-select-1">
	...
	<?php if($row->gender != "Male"){?>														<option>Male</option>
		...
		<?php } ?>												</select>
										...
										<div class="col-md-6 col-xs-12" >
											<div class="form-group">
												...
												<div class="col-md-6 col-sm-9">
													<input class="form-control input-mask-phone" id="form-field-phone" type="text" name="phone" value="<?php echo $row->phoneNo ; ?>" >
												</div>
											</div>
										</div>
										...
										<div class="col-md-6  col-xs-12">
											<div class="form-group">
												...
												<div class="col-md-7 col-md-offset-1 col-sm-9" >
													<input class="form-control input-mask-mobile" type="text" id="form-field-phone" name="mobile" value="<?php echo $row->mobileNo ; ?>" >
												</div>
											</div>
										</div>
									</div>
                                    ...
                                    <div class="form-group">
										<label class="col-sm-2 control-label alignleft">Name:</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" name="nkname" value="<?php echo $row->nk_name ; ?>">
										</div>
									</div>
                                    <div class="row">
										<div class="col-md-6 col-xs-12" >
											<div class="form-group">
												...
												<div class="col-md-7 col-sm-10">
													<input type="text" class="form-control" name="nkjob" value="<?php echo $row->nk_job ; ?>" >
												</div>
											</div>
										</div>
										...
										<div class="col-md-6  col-xs-12">
											<div class="form-group">
												...
												<div class="input-group col-md-6 col-sm-9 col-xs-12" >
													<input class="form-control" type="text" name="relation" value="<?php echo $row->nk_relation; ?>"/>
												</div>
											</div>
										</div>
									</div>
                                    <div class="form-group">
										<label class="col-sm-2 control-label alignleft" >Address:</label>
										<div class="col-sm-9">
											<textarea class="form-control" rows="3" name="nkaddress"><?php echo $row->nk_address; ?></textarea>
										</div>
									</div>
                                    <div class="row">
										<div class="col-md-6 col-xs-12" >
											<div class="form-group">
												<label class=" col-md-4 col-sm-2 control-label alignleft" >Phone:</label>
												<div class="col-md-6 col-sm-9">
													<input class="form-control input-mask-phone" type="text" id="form-field-phone" name="nkphone" value="<?php echo $row->nk_phoneNo ; ?>" >
												</div>
											</div>
										</div>
										...
										<div class="col-md-6  col-xs-12">
											<div class="form-group">
												<label class="col-sm-2 control-label alignleft" >Mobile:</label>
												<div class="col-md-7 col-md-offset-1 col-sm-9" >
													<input type="text" class="form-control input-mask-mobile" id="form-field-phone" name="nkmobile" value="<?php echo $row->nk_mobileNo ; ?>" >
												</div>
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-2 control-label alignleft" >E-mail:</label>
										<div class="col-md-9 col-sm-9" >
											<input type="text" class="form-control" name="nkemail" value="<?php echo $row->nk_email ; ?>" >
										</div>
									</div>
                                ...
                                <h4 class="pink">
									...
									<a href="#modal-form" role="button" class="blue" data-toggle="modal"> Add Image </a>
								</h4>
                                    ...
                                    <?php foreach($pic as $row): ?>
										...
										<li>
											...
											<div class="tools tools-bottom">
												...
												<a title="Delete" onclick="if (confirm('Are You Sure To  Delete This Image?')){ return true;} else{return false;}" href="<?php echo base_url(); ?>index.php/staff/delete_img/<?php echo $row->id; ?>/<?php echo $id; ?>">
													<i class="icon-remove red"></i>
												</a>
											</div>
										</li>
									...
									<div class="col-sm-6">
                                       ...
                                       <div class="row">
                                                  ...
                                                  <div class="form-group">
															...
															<div>
																<select class="input-medium" type="text" name="diag_result">
...
<?php if($row->diag_result != "infection"){?>																				<option value="infection">infection</option>
							<?php } ?>	
											...
											<div class="col-sm-7">
												&nbsp;<?php if($row->diag_file_name != ""){ ?><a href="<?php echo base_url(); ?>index.php/staff/view_diag_letter/<?php echo $row->id; ?>/<?php echo $id; ?>"><button type="button" class="btn btn-link">View</button></a><?php }else{ ?><span>Letter is not Uploaded</span><?php } ?>
											</div>
										</div> 
                                       
                                                                <div class="form-group col-sm-12">
											<label class="col-sm-4 control-label" style="text-align: left;">New Letter</label>
											<div class="col-sm-7">
									...
									<div class="col-sm-6">
                                        ...
                                        <div class="row">
											...
											<div class="col-sm-7">
                                                   ...
                                                   <option><?php echo $row->sponsor; ?></option> 
                                                    <?php if($row->sponsor != "Not Sponsored"){?> 
												 <option>Not Sponsored</option>
                                                 <?php }?>
                                                  <?php if($row->sponsor != "Self Sponsored"){?> 
                                               <option>Self Sponsored</option>
                                                <?php }?>
                                                <?php if($row->sponsor != "Government Centers"){?> 
                                               <option>Government Centers</option>
                                                <?php }?>
                                                 <?php if($row->sponsor != "Government Subsidy"){?> 
                                               <option>Government Subsidy</option>
                                                <?php }?>
                                                <?php if($row->sponsor != "JPA Reimbursed"){?> 
                                               <option>JPA Reimbursed</option>
                                                <?php }?>
                                                <?php if($row->sponsor != "SOCSO Reimbursed"){?> 
                                               <option>SOCSO Reimbursed</option>
                                                <?php }?>
                                                <?php if($row->sponsor != "Baitulmal"){?> 
                                               <option>Baitulmal</option>
                                                <?php }?>
                                                <?php if($row->sponsor != "ATM"){?> 
                                               <option>ATM</option>
                                                <?php }?>
                                                <?php if($row->sponsor != "SUK"){?> 
                                               <option>SUK</option>
                                                <?php }?>
                                                <?php if($row->sponsor != "Angkasa"){?> 
                                ...
                                <h3 class="header green lighter smaller">Patient Schedule</h3>
                                 <div class="space"></div>
                                <div class="row">
                                <?php if($status == "on treatment") {?>
                                 ...
                                 <div class="modal-header no-padding">
                                            ...
                                            <div class="modal-body no-padding">
                                                <table class="table table-bordered no-margin-bottom no-border-top">
                                                    ...
                                                    <?php $j=1; foreach($shift as $shrow):?>
                                                        <tr>
                                                            <td><font color="#0066FF">Shift <?php echo $j;?><br>( <?php echo $shrow->from;?> - <?php echo $shrow->to;?> )</font></td>
                                                            <td<?php foreach($pat_shc as $row): if($row->shift_id == $shrow->shift_id && $row->day =="Sunday"){ ?> bgcolor="#CCCCCC" align="center"<?php } endforeach; ?>></td>
                                                            <td<?php foreach($pat_shc as $row): if($row->shift_id == $shrow->shift_id && $row->day =="Monday"){ ?> bgcolor="#CCCCCC" align="center"<?php } endforeach; ?>></td>
                                                            <td<?php foreach($pat_shc as $row): if($row->shift_id == $shrow->shift_id && $row->day =="Tuesday"){ ?> bgcolor="#CCCCCC" align="center"<?php } endforeach; ?>></td>
                                                            <td<?php foreach($pat_shc as $row): if($row->shift_id == $shrow->shift_id && $row->day =="Wednesday"){ ?> bgcolor="#CCCCCC" align="center"<?php } endforeach; ?>></td>
                                                            <td<?php foreach($pat_shc as $row): if($row->shift_id == $shrow->shift_id && $row->day =="Thursday"){ ?> bgcolor="#CCCCCC" align="center"<?php } endforeach; ?>></td>
                                                            <td<?php foreach($pat_shc as $row): if($row->shift_id == $shrow->shift_id && $row->day =="Friday"){ ?> bgcolor="#CCCCCC" align="center"<?php } endforeach; ?>></td>
                                                            <td<?php foreach($pat_shc as $row): if($row->shift_id == $shrow->shift_id && $row->day =="Saturday"){ ?> bgcolor="#CCCCCC" align="center"<?php } endforeach; ?>></td>
                                            ...
                                            <div class="space"></div>
                                            <p>
                                            <a onclick="if (confirm('Are You Sure To  Delete This Patient Schedule?')){ return true;} else{return false;}" href="<?php echo base_url(); ?>index.php/staff/delete_pat_sch/<?php echo $id; ?>">
											<button class="btn btn-danger btn-block" type="button">Delete Patient Schedule</button></a>
										</p>
                                            
                                <?php } elseif($status == "waiting list"){ ?>
                                ...
                                <?php foreach($medical as $row): ?>
                                 <div class="row">
										...
										<div class="form-group col-sm-5">
											...
											<div class="col-sm-7">
												<input name="refer_from" class="form-control" id="form-field-select-1" value="<?php echo $row->refer_from; ?>" />&nbsp;<?php if($row->refer_file_name !=""){ ?><a href="<?php echo base_url(); ?>index.php/staff/view_refer_letter/<?php echo $row->id; ?>/<?php echo $id; ?>"><button type="button" class="btn btn-link">View Letter</button></a><?php }else{ ?><span>Letter is not Uploaded </span><?php } ?>
											</div>
										</div>
										...
										<div class="form-group col-sm-5">
											...
											<div class="input-group">
																		<input name="refer_date" class="form-control date-picker" id="id-date-picker-3" type="text" data-date-format="dd-mm-yyyy" value="<?php echo $row->refer_date; ?>">
                                ...
                                <div class="row">
										...
										<div class="form-group col-sm-5">
											<label class="col-sm-3 control-label" style="text-align: left;">New Letter</label>
											<div class="col-sm-7">
                                ...
                                <h3 class="header green lighter smaller">Specialists In Charge</h3>            
                                <div class="row">
										<?php foreach($patient as $row):
												$nephro = $row->neph_id;
												$doctor = $row->doc_id;
												endforeach; ?>
										<div class="form-group col-sm-5">
											<label class="col-sm-3 control-label" style="text-align: left;">Nephrologist</label>
											<div class="col-sm-7">
												<select name="neph_incharge" class="form-control" id="form-field-select-1">
                                                
												<option value="<?php echo $nephro; ?>"><?php foreach($neph as $row): if($row->neph_id == $nephro){echo $row->name;} endforeach;?></option>
                                                <?php
												foreach($neph_superviser as $row) :
												foreach($neph as $nrow):
												if($row->neph_id == $nrow->neph_id){
												if($nrow->neph_id != $nephro){ ?>
										...
										<div class="form-group col-sm-5">
											<label class="col-sm-3 control-label" style="text-align: left;">Doctor</label>
											<div class="col-sm-7">
												<select name="doc_incharge" class="form-control" id="form-field-select-1">
												<option value="<?php echo $doctor; ?>"><?php foreach($doc as $row): if($row->doc_id == $doctor){echo $row->name;} endforeach;?></option>
                                                <?php
												foreach($doc_superviser as $row) :
												foreach($doc as $drow):
												if($row->doc_id == $drow->doc_id){
												if($drow->doc_id != $doctor){ ?>
												<option value="<?php echo $drow->doc_id; ?>"><?php echo $drow->name; ?></option><?php }} endforeach; endforeach; ?>
											</select>
											</div>
										</div>
...
<div id="modal-form" class="modal" tabindex="-1">
									<div class="modal-dialog">
                                     <form method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>index.php/staff/add_img/<?php echo $id; ?>">
										<div class="modal-content">
											<div class="modal-header">
												<button type="button" class="close" data-dismiss="modal">&times;</button>
												<h4 class="blue bigger">Add Medical Image</h4>
											</div>
											...
											<div class="modal-body overflow-visible">
												<div class="row">
													<div class="col-xs-12 col-sm-5">
														...
														<input name="med_img" id="id-input-file" type="file" />
													</div>
													...
													<div class="col-xs-12 col-sm-7">
														...
														<div class="form-group">
															<label class="form-field-date" style="text-align: left;">Image Date</label>
															
																<div class="input-group">
																	<input name="img_date" class="form-control date-picker" id="id-date-picker-4" type="text" data-date-format="dd-MM-yyyy" />
																	<span class="input-group-addon">
																		<i class="icon-calendar bigger-110"></i>
																	</span>
																</div>
														...
														<div class="form-group">
															<label class="form-field-comment">Comment</label>

															<div>
																<textarea name="img_comment" class="form-control" rows="3"></textarea>
															</div>
														</div>
													</div>
												</div>
