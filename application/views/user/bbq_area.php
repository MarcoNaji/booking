		...
		<script type="text/javascript">
			...
			$(".date-picker").datepicker({ 
			    ...
			    onSelect: function(date, instance) {
		            ...
		            ({
		                  type: "Post",
		                  url: "<?php echo base_url(); ?>index.php/user/get_slot/3",
		                  data: "date="+date,
		                  dataType : 'json',
							...
							<div class="col-xs-12">
								...
								<div class="row">
									...
									<ul class="ace-thumbnails">
										<li>
											<a href="<?php echo base_url(); ?>assets/img/bbq_area.jpg" title="BBQ Area" data-rel="colorbox">
												<img alt="150x150" height="300" width="500" src="<?php echo base_url(); ?>assets/img/bbq_area.jpg" />
												<div class="text">
													<div class="inner">BBQ Area</div>
												</div>
											</a>
										</li>
									</ul>
									...
									<form class="form-horizontal" id="validation-form" method="post" action="<?php echo base_url(); ?>index.php/user/make_booking/3">
									<div class="col-sm-4">
								...
								<div class="row">
									<div class="col-sm-6">
										<h4>House Rules for the use of the BBQ Area</h4>
										<address>
										The Barbeque area is located beside Block 172.
									   ...
									   <br />
										...
										<li>All bookings must be made through the Condominium Web Portal or in person at the Management Office on a first-come-first-served basis during office hours. Booking is subject to availability and will only be confirmed upon submission of the prescribed form with a refundable deposit of $50.00 by cheque made payable to (The Sixth Avenue Residences Maintenance Fund) within 3 days of booking or before the date of the event during office hours, whichever is applicable. The deposit will be refunded, free of interest, after the event if the BBQ area used is handed over in a clean and satisfactory condition as determined by the Management. Cost of repairs and additional charges, if any, would be deducted from the deposit and the balance would be refunded free of interest to the Resident. However, if the cost of repairs and additional charges exceed the amount deposited, the resident will have to pay the difference.</li>
										...
										<li>No rowdy behaviour is allowed and noise level should be kept to a minimum.</li>
										<li>Live bands or mobile discos are not permitted.</li>
										<li>The number of guests is limited to not more than fifteen (15).</li>
										<li>Residents should ensure that charcoal is extinguished and leftover food disposed off properly.</li>
