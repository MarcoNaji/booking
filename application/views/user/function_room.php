		...
		<script type="text/javascript">
			...
			$(".date-picker").datepicker({ 
			    ...
			    onSelect: function(date, instance) {
		            ...
		            ({
		                  type: "Post",
		                  url: "<?php echo base_url(); ?>index.php/user/get_slot/1",
		                  data: "date="+date,
		                  dataType : 'json',
				...
				var colorbox_params = {
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Function Room</li>
						</ul><!-- .breadcrumb -->
					</div>
							...
							<div class="col-xs-12">
								...
								<div class="row">
									...
									<ul class="ace-thumbnails">
										<li>
											<a href="<?php echo base_url(); ?>assets/img/function_room.jpg" title="Function Room" data-rel="colorbox">
												<img alt="150x150" height="300" width="500" src="<?php echo base_url(); ?>assets/img/function_room.jpg" />
												<div class="text">
													<div class="inner">Function Room</div>
												</div>
											</a>
										</li>
									</ul>
									...
									<form class="form-horizontal" id="validation-form" method="post" action="<?php echo base_url(); ?>index.php/user/make_booking/1">
									<div class="col-sm-4">
								...
								<div class="row">
									<div class="col-sm-6">
										<h4>House Rules for the use of the Clubhouse / Function Room</h4>
										<address>
									    <br />
									   Opening times: 
									    <br />
									   ...
									   <br />
										...
										<hr />
										<ol>
										<li>Bookings can be made up to one (1) month in advance and are limited to a maximum of one (1) session per unit per calendar month.</li>
										<li>All bookings must be made through Condominium Web Portal or in person at the Management Office on a first-come-first-served basis during office hours. Booking is subject to availability and will only be confirmed upon submission of the prescribed form with a refundable deposit of $200.00 by cheque made payable to The (Sixth Avenue Residences Maintenance Fund) within 3 days of booking or before the date of the event during office hours, whichever is earlier. The deposit will be refunded, free of interest, after the event if the premise used is handed over in a clean and satisfactory condition as determined by the Management. Cost of repairs and additional charges, if any, would be deducted from the deposit and the balance would be refunded free of interest to the Resident. However, if the cost of repairs and additional charges exceed the amount deposited, the resident will have to pay the difference.</li>
										<li>To discourage frivolous bookings, residents who fail to turn up after booking, without making proper cancellation, will be barred from booking the facility for one (1) month. Cancellation of bookings must be made at least seven (7) days before the date booked, otherwise the deposit will be forfeited.</li>
										<li>The above facility should not be used for commercial, political, religious, company gatherings or illegal activities.</li>
										<li>Live bands or mobile discos are not permitted.</li>
										<li>The number of guests is limited to not more than twenty (20).</li>
										<li>The Management reserves the right to use the Function room for official matters.</li>
