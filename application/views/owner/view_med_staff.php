				...
				function tooltip_placement(context, source) {
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
                            ...
                            <li class="active">View Medical Staff</li>
						</ul><!-- .breadcrumb -->
						...
						<div class="row">
							<div class="col-xs-12">
								<div class="page-header">
									<h1>Medical Staff Information</h1>
								</div><!-- /.page-header -->
                                <?php foreach($staff as $row): ?>
                                <?php if($row->deleted == 1){ echo '<div class="alert alert-danger">
											<strong>
												<i class="icon-remove"></i>
												This Medical Staff is Deleted!
											</strong>
											<br />
										</div>'; }
                                       ?>
										...
										<div class="row">
											...
											<div class="col-xs-2"></div>
												<div class="center col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-8 ">
													...
													<a href="<?php echo base_url(); ?>index.php/owner/edit_staff/<?php echo $row->staff_id; ?>" class="btn btn-sm btn-block btn-default">
														<i class="icon-edit bigger-120"></i>
														<span class="bigger-110">Edit</span>
													</a>
                                                    <?php if($row->deleted != 1){ ?>
                                                    <a onclick="if (confirm('Are You Sure To  Delete <?php echo $row->name; ?>?')){ return true;} else{return false;}" href="<?php echo base_url(); ?>index.php/owner/delete_staff2/<?php echo $row->staff_id; ?>" class="btn btn-sm btn-block btn-danger">
														<i class="icon-trash bigger-120"></i>
														<span class="bigger-110">Delete</span>
													</a>
                                                    <?php }else{ ?>
                                                    
                                                    <a onclick="if (confirm('Are You Sure To  Un-Delete <?php echo $row->name; ?>?')){ return true;} else{return false;}" href="<?php echo base_url(); ?>index.php/owner/undelete_staff2/<?php echo $row->staff_id; ?>" class="btn btn-sm btn-block btn-danger">
														<i class="icon-undo bigger-120"></i>
														<span class="bigger-110">Un Delete</span>
                                                        </a>
                                                        <?php } ?>
												...
												<div class="col-md-6 col-xs-12" >
													<div class="form-group">
														...
														<div class="col-md-8 col-sm-10">
															<input type="text" class="form-control" readonly="readonly" value="<?php echo $row->staff_ic; ?>">
														</div>
													</div>
												</div>
												...
												<div class="col-md-6  col-xs-12">
													<div class="form-group">
														...
														<div class="col-md-9 col-md-offset-1 col-sm-10" >
															<input type="text" class="form-control" readonly="readonly" value="<?php foreach($center as $crow): if($row->center_id == $crow->center_id){ echo $crow->name; }endforeach;  ?> ">
														</div>
													</div>
												</div>
											</div>
