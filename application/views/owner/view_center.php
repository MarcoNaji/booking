					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
                            ...
                            <li>
                                ...
                                <li class="active">Center Info </li>
						</ul><!-- .breadcrumb -->
									...
									<div class="col-md-4" >
										...
										<div class="widget-box">
											...
											<div class="widget-body" align="center">
												<div class="widget-main" id="div_logo">
                                                <?php if($row->logo_name == ""){?>
													<img id="avatar" height="50" width="50" class="editable img-responsive" alt="Alex's Avatar" src="<?php echo base_url(); ?>assets/img/default_center.png"></img>
                                                    <?php }else{ ?>
       <img height="50" width="50" id="avatar" class="editable img-responsive" alt="Alex's Avatar" src="<?php echo base_url(); ?>img/center/<?php echo $row->center_id; ?>/<?php echo $row->logo_name; ?>"></img>
       <?php } ?>                                             
										...
										<div class="row">
											...
											<div class="col-xs-2"></div>
												<div class="center col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-8 ">
													<a href="<?php echo base_url(); ?>index.php/owner/edit_center/<?php echo $row->center_id; ?>">
									...
									<div class="col-md-8">
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<input type="text" class="form-control" readonly="readonly" name="name" placeholder="Required" value="<?php echo $row->name; ?>"/>
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<textarea class="form-control" readonly="readonly" rows="3" name="address" placeholder="Required"><?php echo $row->address; ?></textarea>
												</div>
											</div>
												...
												<div class="col-md-6 col-xs-12" >
													<div class="form-group">
														...
														<div class="col-md-8 col-sm-10">
															<input type="text" class="form-control" readonly="readonly" name="phone" placeholder="Required" value="<?php echo $row->phone; ?>"/>
														</div>
													</div>
												</div>
												...
												<div class="col-md-6  col-xs-12">
													<div class="form-group">
														...
														<div class="col-md-9 col-md-offset-1 col-sm-10" >
															<input type="text" class="form-control" readonly="readonly" name="fax" value="<?php echo $row->fax; ?>">
														</div>
													</div>
												</div>
											</div>
											...
											<div class="row">
												<div class="col-md-6 col-xs-12">
													<div class="form-group">
														...
														<div class="col-md-8 col-sm-10">
															<input type="text" class="form-control" readonly="readonly" name="email" placeholder="Required" value="<?php echo $row->email; ?>"/>
														</div>
													</div>
												</div>
												...
												<div class="col-md-6 col-xs-12">
													<div class="form-group">
														...
														<div class="col-md-9 col-md-offset-1 col-sm-10">
															<input type="text" class="form-control" readonly="readonly" name="zip" placeholder="Required" value="<?php echo $row->zip_code; ?>"/>
														</div>
													</div>
												</div>
											</div>
                                            <div class="row">
												<div class="col-md-6 col-xs-12">
													<div class="form-group">
														...
														<div class="col-md-8 col-sm-10">
															<input type="text" class="form-control" readonly="readonly" name="email" placeholder="Required" value="<?php echo $row->machine; ?>"/>
														</div>
													</div>
												</div>
                                                </div>
