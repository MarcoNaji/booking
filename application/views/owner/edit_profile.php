            ...
            form.submit();
				...
				function tooltip_placement(context, source) {
					...
					<div class="page-content">
						<div class="row">
							<div class="col-xs-12">
                            <form id="edit_form" class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>index.php/owner/save_edit_profile" novalidate="novalidate">
									...
									<div class="col-md-8">
											...
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-10">
													<input name="ic" type="text" title="If Incorrect, Contact Adminstration" class="form-control" readonly="readonly" value="<?php echo $row->owner_ic; ?>" >
												</div>
											</div>
                                            </div>
