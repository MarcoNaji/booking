			...
			var div = bootbox.dialog({
				...
				buttons: {
					"delete" : {
						...
						"callback": function() {
							jQuery.post(
            "<?php echo base_url(); ?>index.php/doc/delete_visit"
...
<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<a title="View" class="blue" href="<?php echo base_url(); ?>index.php/doc/view_req/<?php echo $row->id; ?>">
															...
															<div class="visible-xs visible-sm hidden-md hidden-lg">
																<div class="inline position-relative">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
																		<li>
																			<a href="<?php echo base_url(); ?>index.php/doc/view_req/<?php echo $row->id; ?>" class="tooltip-info" data-rel="tooltip" title="View">
																				<span class="blue">
