...
<!-- ace settings handler -->
			...
			jQuery(function($) {
				...
				function tooltip_placement(context, source) {
					...
					<ul class="breadcrumb">
                            ...
                            <li>
							<i class=""></i>
								<a href="<?php echo base_url(); ?>index.php/doc/center">Dialysis Centers</a>
                                </li>
                                <li class="active">View Center Info</li>
						</ul><!-- .breadcrumb -->
                    ...
                    <div class="page-header">
							<h1>
								 Center Information >> <?php if($crow->logo_name == ""){?>
       ...
       <?php } ?>  <font class="green"><?php echo $crow->name; ?></font>
							</h1>
						</div><!-- /.page-header -->
                       <!-- PAGE CONTENT BEGINS -->
                                       ...
                                       <form class="form-horizontal">
                                        <div class="col-xs-12 col-sm-5">
                                                  <div class="form-group">
															...
															<div class="col-sm-7">
																<input class="form-control" type="text" name="name" placeholder="Required" value="<?php echo $name = $crow->phone; ?>" readonly="readonly"/>
                                                                </div>
                                                                </div>
                                                                 <div class="form-group">
                        ...
                        <div class="clearfix form-actions">
							        <div class="center">
							            &nbsp; &nbsp;
                                        <a onclick="if (confirm('Are You Sure To  Delete <?php echo $name; ?> From your Supervision List?')){ return true;} else{return false;}" href="<?php echo base_url(); ?>index.php/doc/delete_center_sup/<?php echo $row->id; ?>"> <button type="button"  class="btn btn-danger">
							                Delete
							            </button></a>
