								...
								<div class="row">
                                    ...
                                    <?php if($row->image_name == ""){?>
										<div class="center">
                                            ...
                                            <div class="center">
											<span class="profile-picture">
												<img height="200" width="200" id="avatar" src="<?php echo base_url(); ?>img/doc/<?php echo $row->doc_id; ?>/<?php echo $row->image_name; ?>"></img>
											</span>
                                            <?php } ?>
										...
										<div class="row">
											...
											<div class="col-xs-2"></div>
												<div class="center col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-8 ">
													<a href="<?php echo base_url(); ?>index.php/doc/edit_profile" class="btn btn-sm btn-block btn-default">
									...
									<div class="col-md-8">
										<form class="form-horizontal" role="form">
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<input type="text" class="form-control" readonly="readonly" value="<?php echo $row->doc_ic; ?>" >
												</div>
											</div>
