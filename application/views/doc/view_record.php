				...
				function tooltip_placement(context, source) {
					...
					<div class="page-content">
						<div class="page-header">
                            ...
                            <button class="btn btn-danger btn-sm" type="button"  onclick="location.href='<?php echo base_url(); ?>index.php/doc/d_record/<?php echo $id; ?>'">
...
<?php foreach($owner as $orow): if($orow->owner_id != $row->ending_staff){ ?>																<option value="<?php echo $orow->owner_id; ?>"><?php echo $orow->name; ?></option>  <?php }endforeach; ?>
								...
								<div class="clearfix form-actions">
							        <div class="center">
							            ...
							            &nbsp;&nbsp;
							            <button type="button" onclick="location.href='<?php echo base_url(); ?>index.php/doc/d_record/<?php echo $id; ?>'" class="btn btn-danger">
							                Back
							            </button>
							        </div>
    							</div>
