							...
							<div class="btn-toolbar pull-right">
											<div class="btn-group">
												...
												<ul class="dropdown-menu dropdown-info pull-right">
													<li>
														<a href="<?php echo base_url(); ?>index.php/doc/view_pat/<?php echo $row->pat_id; ?>"><b>Patient Details</b></a>
													</li>

													<li>
														<a href="<?php echo base_url(); ?>index.php/doc/d_record/<?php echo $row->pat_id; ?>">Dialysis Record</a>
													</li>

													<li>
														<a href="<?php echo base_url(); ?>index.php/doc/view_summary/<?php echo $row->pat_id; ?>">Clincal and Biochemistry Summary</a>
													</li>
													
													<li>
														<a href="<?php echo base_url(); ?>index.php/doc/view_history/<?php echo $row->pat_id; ?>">Patient History</a>
													</li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div id="user-profile-2" class="user-profile">
                                 <form class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php echo base_url(); ?>index.php/doc/edit_pat/<?php echo $id; ?>">
                                  <?php foreach($patient as $row):
										$status = $row->status;
...
<?php if($row->diag_result != "infection"){?>																				<option value="infection">infection</option>
							<?php } ?>	
											...
											<div class="col-sm-7">
												&nbsp;<?php if($row->diag_file_name != ""){ ?><a href="<?php echo base_url(); ?>index.php/doc/view_diag_letter/<?php echo $row->id; ?>/<?php echo $id; ?>"><button type="button" class="btn btn-link">View</button></a><?php }else{ ?><span>Letter is not Uploaded</span><?php } ?>
											</div>
										</div> 
                                                            </div>
												</div>
                                ...
                                <?php foreach($medical as $row): ?>
                                 <div class="row">
										...
										<div class="form-group col-sm-5">
											...
											<div class="col-sm-7">
												<input name="refer_from" disabled="disabled" class="form-control" id="form-field-select-1" value="<?php echo $row->refer_from; ?>" />&nbsp;<?php if($row->refer_file_name !=""){ ?><a href="<?php echo base_url(); ?>index.php/doc/view_refer_letter/<?php echo $row->id; ?>/<?php echo $id; ?>"><button type="button" class="btn btn-link">View Letter</button></a><?php }else{ ?><span>Letter is not Uploaded </span><?php } ?>
											</div>
										</div>
                                  ...
                                  <?php endforeach; ?>  
                                   ...
                                   <div class="space"></div>
                                    <?php foreach($center as $row): if($row->center_id == $center_id){?>
                                    <div class="row">
									<div class="col-xs-12">
