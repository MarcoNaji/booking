				...
				function tooltip_placement(context, source) {
					...
					<div class="page-content">
						<div class="page-header">
                            ...
                            <button class="btn btn-danger btn-sm" type="button"  onclick="location.href='<?php echo base_url(); ?>index.php/doc/view_history/<?php echo $pat_id; ?>'">
...
echo $drow->title; echo $drow->name;														
                            ...
                            <h3 class="header smaller lighter green">Personal Info</h3>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="ic" readonly="readonly" value="<?php echo $pat_ic = $row->pat_ic ; ?>" class="form-control" >
										</div>
									</div>
										...
										<div class="widget-box">
											...
											<div class="widget-body">
												<div class="widget-main">
                                					...
                                					<textarea name="gses_other" readonly="readonly" id="group1" class="form-control" rows="3"><?php if($row->other =="" || $row->other =="0"){echo "";}else{echo $row->other;} ?></textarea>
												</div>
											</div>
										</div>
                                        <?php endforeach; ?>
										...
										<div class="widget-box">
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<div class="space-6"></div>
													<label class="control-label" for="address-2">Others</label>
                                					<textarea name="endo_other" readonly="readonly" id="group2" class="form-control" rows="3"><?php if($row->other =="" || $row->other =="0"){echo "";}else{echo $row->other;} ?></textarea>
												</div>
											</div>
										</div>
                                        <?php endforeach; ?>
										...
										<div class="widget-box">
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<div class="space-6"></div>
													<label class="control-label" for="address-2">Others</label>
                                					<textarea name="gastro_other" readonly="readonly" id="group3" class="form-control" rows="3"><?php if($row->other =="" || $row->other =="0"){echo "";}else{echo $row->other;} ?></textarea>
												</div>
											</div>
										</div>
                                        <?php endforeach; ?>
										...
										<div class="widget-box">
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<div class="space-6"></div>
													<label class="control-label" for="address-2">Others</label>
                                					<textarea name="res_system_other" readonly="readonly" id="group4" class="form-control" rows="3"><?php if($row->other =="" || $row->other =="0"){echo "";}else{echo $row->other;} ?></textarea>
												</div>
											</div>
										</div>
                                        <?php endforeach; ?>
										...
										<div class="widget-box">
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<div class="space-6"></div>
													<label class="control-label" for="address-2">Others</label>
                                					<textarea name="musc_other" readonly="readonly" id="group5" class="form-control" rows="3"><?php if($row->other =="" || $row->other =="0"){echo "";}else{echo $row->other;} ?></textarea>
												</div>
											</div>
										</div>
                                        <?php endforeach; ?>
										...
										<div class="widget-box">
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<div class="space-6"></div>
													<label class="control-label" for="address-2">Others</label>
                                					<textarea name="card_other" readonly="readonly" id="group6" class="form-control" rows="3"><?php if($row->other =="" || $row->other =="0"){echo "";}else{echo $row->other;} ?></textarea>
										...
										<div class="widget-box">
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<div class="space-6"></div>
													<label class="control-label" for="address-2">Others</label>
                                					<textarea name="hema_other" readonly="readonly" id="group7" class="form-control" rows="3"><?php if($row->other =="" || $row->other =="0"){echo "";}else{echo $row->other;} ?></textarea>
												</div>
											</div>
										</div>
                                        <?php endforeach; ?>
										...
										<div class="widget-box">
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<div class="space-6"></div>
													<label class="control-label" for="address-2">Others</label>
                                					<textarea name="neuro_other" readonly="readonly" id="group8" class="form-control" rows="3"><?php if($row->other =="" || $row->other =="0"){echo "";}else{echo $row->other;} ?></textarea>
												</div>
											</div>
										</div>
                                        <?php endforeach; ?>
                                 ...
                                 <?php foreach($other_problem as $row): ?>
										<div class="widget-box">
											...
											<div class="widget-body">
												<div class="widget-main">
													<label class="control-label" for="address-2">Others</label>
                                					<textarea name="other_problem" readonly="readonly" id="group9" class="form-control" rows="3"><?php if($row->other =="" || $row->other =="0"){echo "";}else{echo $row->other;} ?></textarea>
												</div>
											</div>
										</div>
                                        <?php endforeach; ?>
										...
										<div class="widget-box center">
											...
											<div class="widget-body">
												<div class="widget-main">
                                					...
                                					<textarea name="sum_problem" readonly="readonly" id="group10" class="form-control" rows="3"><?php if($row->problem_summary =="" || $row->problem_summary =="0"){echo "";}else{echo $row->problem_summary;} ?></textarea>
                                                    <label class="control-label" for="address-2">Summary of Examination</label>
                                					<textarea name="sum_examination" readonly="readonly" id="group10" class="form-control" rows="3"><?php if($row->examination_summary =="" || $row->examination_summary =="0"){echo "";}else{echo $row->examination_summary;} ?></textarea>
												</div>
											</div>
										</div>
                                        </div>
										...
										<div class="widget-box">
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<div class="space-6"></div>
													<label class="control-label" for="address-2">Others</label> 
                                					<textarea name="arb_other" readonly="readonly" id="med_group1_8" class="form-control" rows="3"><?php if($row->other =="" || $row->other =="0"){echo "";}else{echo $row->other;} ?></textarea>
										...
										<div class="widget-box">
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<div class="space-6"></div>
													<label class="control-label" for="address-2">Others</label> 
                                					<textarea name="beta_other" readonly="readonly" id="med_group2_5" class="form-control" rows="3"><?php if($row->other =="" || $row->other =="0"){echo "";}else{echo $row->other;} ?></textarea>
												</div>
											</div>
										</div>
                                        <?php endforeach; ?>
										...
										<div class="widget-box">
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<div class="space-6"></div>
													<label class="control-label" for="address-2">Others</label> 
                                					<textarea name="ace_other" readonly="readonly" id="med_group3_3" class="form-control" rows="3"><?php if($row->other =="" || $row->other =="0"){echo "";}else{echo $row->other;} ?></textarea>
												</div>
											</div>
										</div>
                                        <?php endforeach; ?>
										...
										<div class="widget-box">
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<div class="space-6"></div>
													<label class="control-label" for="address-2">Others</label> 
                                					<textarea name="ccb_other" readonly="readonly" id="med_group4_3" class="form-control" rows="3"><?php if($row->other =="" || $row->other =="0"){echo "";}else{echo $row->other;} ?></textarea>
												</div>
											</div>
										</div>
                                        <?php endforeach; ?>
										...
										<div class="widget-box">
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<div class="space-6"></div>
													<label class="control-label" for="address-2">Others</label> 
                                					<textarea name="vitamin_other" readonly="readonly" id="med_group5_3" class="form-control" rows="3"><?php if($row->other =="" || $row->other =="0"){echo "";}else{echo $row->other;} ?></textarea>
												</div>
											</div>
										</div>
                                        <?php endforeach; ?>
										...
										<div class="widget-box">
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<div class="space-6"></div>
													<label class="control-label" for="address-2">Others</label> 
                                					<textarea name="hematinics_other" readonly="readonly" id="med_group6_4" class="form-control" rows="3"><?php if($row->other =="" || $row->other =="0"){echo "";}else{echo $row->other;} ?></textarea>
										...
										<div class="widget-box">
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<div class="space-6"></div>
													<label class="control-label" for="address-2">Others</label> 
                                					<textarea name="aab_other" readonly="readonly" id="med_group7_2" class="form-control" rows="3"><?php if($row->other =="" || $row->other =="0"){echo "";}else{echo $row->other;} ?></textarea>
										...
										<div class="widget-box">
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<div class="space-6"></div>
													<label class="control-label" for="address-2">Others</label> 
                                					<textarea name="vasodilators_other" readonly="readonly" id="med_group8_3" class="form-control" rows="3"><?php if($row->other =="" || $row->other =="0"){echo "";}else{echo $row->other;} ?></textarea>
										...
										<div class="widget-box">
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<div class="space-6"></div>
													<label class="control-label" for="address-2">Others</label> 
                                					<textarea name="phosphate_other" readonly="readonly" id="med_group9_2" class="form-control" rows="3"><?php if($row->other =="" || $row->other =="0"){echo "";}else{echo $row->other;} ?></textarea>
										...
										<div class="widget-box">
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<div class="space-6"></div>
													<label class="control-label" for="address-2">Others</label> 
                                					<textarea name="diuretics_other" readonly="readonly" id="med_group10_2" class="form-control" rows="3"><?php if($row->other =="" || $row->other =="0"){echo "";}else{echo $row->other;} ?></textarea>
										...
										<div class="widget-box">
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<div class="space-6"></div>
													<label class="control-label" for="address-2">Others</label>
                                					<textarea name="ery_other" readonly="readonly" id="med_group11_1" class="form-control" rows="3"><?php if($row->other =="" || $row->other =="0"){echo "";}else{echo $row->other;} ?></textarea>
												</div>
											</div>
										</div>
                                        <?php endforeach; ?>
                                    ...
                                    <?php foreach($other_medic as $row): ?>
										<div class="widget-box">
											...
											<div class="widget-body">
												<div class="widget-main">
													<label class="control-label" for="address-2">Others</label> 
                                					<textarea name="other_medic" readonly="readonly" id="med_group11_1" class="form-control" rows="3"><?php if($row->other =="" || $row->other =="0"){echo "";}else{echo $row->other;} ?></textarea>
										...
										<div class="widget-box center">
											...
											<div class="widget-body">
												<div class="widget-main">
                                					...
                                					<textarea name="clinical_plan" readonly="readonly" id="med_group13_1" class="form-control" rows="3"><?php if($row->clinical_plan =="" || $row->clinical_plan =="0"){echo "";}else{echo $row->clinical_plan;} ?></textarea>
