						...
						<div class="page-header">
							<h1>
								...
								<div class="row">
                                   ...
                                   <a href="javascript:window.open('<?php echo base_url(); ?>index.php/print_report/reportB_doc/<?php echo $year; ?>/<?php echo $selected_center; ?>','blank')">
                                                ...
                                                <?php foreach($pat as $row):
												 ...
												 ?>
													<tr>
														...
														<td>
															<a href="<?php echo base_url(); ?>index.php/doc/view_pat/<?php echo $row->pat_id; ?>" target="_blank"><?php echo $row->name;  ?></a>
														</td>
