				...
				function tooltip_placement(context, source) {
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
                            ...
                            <li>
                            <a href="<?php echo base_url(); ?>index.php/doc/view_summary/<?php echo $pat_id; ?>">Clinical and Biochemisry Summary</a>
                            </li>
					...
					<div class="page-content">
						<div class="page-header">
                            ...
                            <button class="btn btn-danger btn-sm" type="button"  onclick="location.href='<?php echo base_url(); ?>index.php/doc/view_summary/<?php echo $pat_id; ?>'">
						...
						<div class="row">
							<div class="col-xs-12">
                             <?php foreach($clinical_xyz as $row): ?>
								<form class="form-horizontal" method="post" action="<?php echo base_url(); ?>index.php/doc/edit_summary_detail/<?php echo $pat_id; ?>/<?php echo $row->id; ?>">
								<!-- PAGE CONTENT BEGINS -->
