	 ...
	 $("#yearB").attr("disabled", true);
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active"><a href="<?php echo base_url(); ?>index.php/doc/pat_list">Patient List</a></li>
						...
						<div class="page-header">
							<h1>
								...
								<div class="row">
                                   ...
                                   <a href="javascript:window.open('<?php echo base_url(); ?>index.php/print_report/reportA_doc/<?php echo $month; ?>/<?php echo $year; ?>/<?php echo $selected_center; ?>','blank')">
...
mcmol/L
 ...
 <th>HepB Antibody</th>
												...
												foreach($pat as $prow): if($row->pat_id == $prow->pat_id){ 
												?>
													<tr>
														<td class="center">
															<label>
														...
														<td>
															<a href="<?php echo base_url(); ?>index.php/doc/view_pat/<?php echo $prow->pat_id; ?>" target="_blank"><?php echo $prow->name; ?></a>
														</td>
        ...
        <div id="modal-form" class="modal" tabindex="-1">
                                    ...
                                    <form id="submit_form" method="post" action="<?php echo base_url(); ?>index.php/doc/bio_summary" novalidate>
...
<?php foreach($supervision as $row): if($row->status =="accepted"){foreach($center as $crow): if($row->center_id == $crow->center_id){ ?>																			
                                                ...
                                                <hr>
													...
													<div class="col-xs-12 col-sm-3">
														...
														<div>
																			<label class="blue">
														<input name="summary" checked id="a" type="radio" class="ace" value="A" />
