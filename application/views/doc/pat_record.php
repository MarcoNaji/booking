								...
								<div class="btn-toolbar pull-right">
											<div class="btn-group">
												...
												<ul class="dropdown-menu dropdown-info pull-right">
													<li>
														<a href="<?php echo base_url(); ?>index.php/doc/view_pat/<?php echo $id; ?>">Patient Details</a>
													</li>

													<li>
														<a href="<?php echo base_url(); ?>index.php/doc/d_record/<?php echo $id; ?>"><b>Dialysis Record</b></a>
													</li>

													<li>
														<a href="<?php echo base_url(); ?>index.php/doc/view_summary/<?php echo $id; ?>">Clincal and Biochemistry Summary</a>
													</li>
													
													<li>
														<a href="<?php echo base_url(); ?>index.php/doc/view_history/<?php echo $id; ?>">Patient History</a>
													</li>
													...
													<tr>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<a title="View" class="blue" href="<?php echo base_url(); ?>index.php/doc/view_record/<?php echo $row->record_id; ?>/<?php echo $id; ?>">
															...
															<div class="visible-xs visible-sm hidden-md hidden-lg">
																<div class="inline position-relative">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
																		<li>
																			<a href="<?php echo base_url(); ?>index.php/doc/view_record/<?php echo $row->record_id; ?>/<?php echo $id; ?>" class="tooltip-info" data-rel="tooltip" title="View">
																				<span class="blue">
