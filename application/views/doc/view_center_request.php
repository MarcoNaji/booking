       ...
       <?php } ?>  <font class="blue"><?php echo $crow->name; ?></font>
                       ...
                       <!-- PAGE CONTENT BEGINS -->
                        ...
                        <div class="clearfix form-actions">
							        <div class="center">
							            &nbsp; &nbsp;
							            <a href="<?php echo base_url(); ?>index.php/doc/accept_sup_request/<?php echo $id  ?>"><button type="button" class="btn btn-success">
							                Accept
							            </button></a>
							            
							            &nbsp; &nbsp;
                                        <a href="<?php echo base_url(); ?>index.php/doc/reject_sup_request/<?php echo $row->id; ?>"> <button type="button"  class="btn btn-danger">
							                Reject
							            </button></a>
