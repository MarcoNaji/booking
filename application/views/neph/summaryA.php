						...
						<div class="page-header">
							<h1>
								...
								<div class="row">
                                   ...
                                   <a href="javascript:window.open('<?php echo base_url(); ?>index.php/print_report/reportA_neph/<?php echo $month; ?>/<?php echo $year; ?>/<?php echo $selected_center; ?>','blank')">
 ...
 <th>HepB Antibody</th>
												...
												?>
													<tr>
														...
														<td>
															<a href="<?php echo base_url(); ?>index.php/neph/view_pat/<?php echo $prow->pat_id; ?>" target="_blank"><?php echo $prow->name; ?></a>
														</td>
