       ...
       <?php } ?>  <font class="green"><?php echo $crow->name; ?></font>
                       ...
                       <!-- PAGE CONTENT BEGINS -->
                        ...
                        <div class="clearfix form-actions">
							        <div class="center">
							            &nbsp; &nbsp;
                                        <a onclick="if (confirm('Are You Sure To  Delete <?php echo $name; ?> From your Supervision List?')){ return true;} else{return false;}" href="<?php echo base_url(); ?>index.php/neph/delete_center_sup/<?php echo $row->id; ?>"> <button type="button"  class="btn btn-danger">
							                Delete
							            </button></a>
