													...
													<tr>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<a title="View" class="blue" href="<?php echo base_url(); ?>index.php/neph/view_pat/<?php echo $row->pat_id; ?>">
																	<i class="icon-zoom-in bigger-130"></i>
																</a>
                                                            																<a title="Dialysis Record" class="green" href="<?php echo base_url(); ?>index.php/neph/d_record/<?php echo $row->pat_id; ?>">
																	<i class="icon-calendar bigger-130"></i>
																</a>
                                                            
<a title="Clincal and Biochemistry Summary" class="orange" href="<?php echo base_url(); ?>index.php/neph/view_summary/<?php echo $row->pat_id; ?>">
															...
															<div class="visible-xs visible-sm hidden-md hidden-lg">
																<div class="inline position-relative">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
																		<li>
																			<a href="<?php echo base_url(); ?>index.php/neph/view_pat/<?php echo $row->pat_id; ?>" class="tooltip-info" data-rel="tooltip" title="View">
																				<span class="blue">
...
<li>
																			<a href="<?php echo base_url(); ?>index.php/neph/d_record/<?php echo $row->pat_id; ?>" class="tooltip-success" data-rel="tooltip" title="Record">
																				<span class="green">
...
<li>
																			<a href="<?php echo base_url(); ?>index.php/neph/view_summary/<?php echo $row->pat_id; ?>" class="tooltip-orange" data-rel="tooltip" title="Summary">
																				<span class="orange">
											...
											<ul class="dropdown-menu pull-right dropdown-125 dropdown-lighter dropdown-caret">
												...
												<li>
													<a href="<?php echo base_url(); ?>index.php/print_report/full_report/<?php echo $row->pat_id; ?>" target="_blank">Full Report</a>
                                                            ...
                                                            <div class="widget-toolbar no-border">
											<button type="button" onclick="location.href='<?php echo base_url(); ?>index.php/neph/view_history/<?php echo $row->pat_id; ?>'" class="btn btn-minier btn-primary">
												Patient History
											</button>
        ...
        <div id="modal-form" class="modal" tabindex="-1">
                                    ...
                                    <form id="submit_form" method="post" action="<?php echo base_url(); ?>index.php/neph/bio_summary" novalidate="novalidate">
