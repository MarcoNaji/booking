		...
		<div class="navbar navbar-default" id="navbar">
			...
			<div class="navbar-container" id="navbar-container">
				<div class="navbar-header pull-left">
					<a href="<?php echo base_url(); ?>index.php/neph" class="navbar-brand">
						<small>
					...
					<ul class="nav ace-nav">
						<li class="light-blue">
							...
							<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
								<li>
									<a href="<?php echo base_url(); ?>index.php/neph/password_page">
										<i class="icon-cog"></i>
										Change Password
									</a>
								</li>
								...
								<li>
									<a href="<?php echo base_url(); ?>index.php/neph/profile">
										<i class="icon-user"></i>
										Profile
									</a>
								</li>
