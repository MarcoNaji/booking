			...
			$('.date-picker').datepicker({autoclose:true}).next().on(ace.click_event, function(){
				...
				function tooltip_placement(context, source) {
					...
					<div class="page-content">
							...
							<div class="btn-toolbar pull-right">
											<div class="btn-group">
												...
												<ul class="dropdown-menu dropdown-info pull-right">
													...
													<li>
														<a href="<?php echo base_url(); ?>index.php/neph/view_summary/<?php echo $pat_id; ?>"><b>Clincal and Biochemistry Summary</b></a>
													</li>
						...
						<div class="row">
							<div class="col-xs-12">
								<form class="form-horizontal" method="post" action="<?php echo base_url(); ?>index.php/neph/edit_summary/<?php echo $pat_id; ?>">
								<!-- PAGE CONTENT BEGINS -->
...
<td><a href="<?php echo base_url(); ?>index.php/neph/view_summary_detail/<?php echo $pat_id; ?>/<?php echo $row->id; ?>" title="View More">
																				<span class="blue">
