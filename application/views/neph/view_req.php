...
<!-- ace settings handler -->
				...
				$('textarea.limited').inputlimiter({
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
                            <a href="<?php echo base_url(); ?>index.php/neph/request">Visiting Request</a>
                            </li>
       ...
       <?php } ?>  <font class="blue"><?php echo $crow->name; ?></font>
							        ...
							        <div class="center">
							            &nbsp; &nbsp;
							            <a href="<?php echo base_url(); ?>index.php/neph/accept_req/<?php echo $id; ?>"><button type="button" class="btn btn-success">
							                Accept
							            </button></a>
        ...
        <div id="modal-form" class="modal" tabindex="-1">
									<div class="modal-dialog">
                                     <form method="post" action="<?php echo base_url(); ?>index.php/neph/reject_req/<?php echo $id; ?>">
