								...
								<div class="btn-toolbar pull-right">
											<div class="btn-group">
												...
												<ul class="dropdown-menu dropdown-info pull-right">
													<li>
														<a href="<?php echo base_url(); ?>index.php/neph/view_pat/<?php echo $pat_id; ?>">Patient Details</a>
													</li>

													<li>
														<a href="<?php echo base_url(); ?>index.php/neph/d_record/<?php echo $pat_id; ?>">Dialysis Record</a>
													</li>

													<li>
														<a href="<?php echo base_url(); ?>index.php/neph/view_summary/<?php echo $pat_id; ?>">Clincal and Biochemistry Summary</a>
													</li>
													
													<li>
														<a href="<?php echo base_url(); ?>index.php/neph/view_history/<?php echo $pat_id; ?>"><b>Patient History</b></a>
													</li>
													...
													<tr>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<a title="View" class="blue" href="<?php echo base_url(); ?>index.php/neph/view_history_detail/<?php echo $row->history_id; ?>/<?php echo $row->pat_id; ?>">
															...
															<div class="visible-xs visible-sm hidden-md hidden-lg">
																<div class="inline position-relative">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
																		<li>
																			<a href="<?php echo base_url(); ?>index.php/neph/view_history_detail/<?php echo $row->history_id; ?>/<?php echo $row->pat_id; ?>" class="tooltip-info" data-rel="tooltip" title="View">
																				<span class="blue">
